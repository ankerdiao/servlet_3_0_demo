 ...
 */
public class HttpHelloWorldClientHandler extends SimpleChannelInboundHandler<HttpObject> {

    private static final Logger logger = Logger.getLogger(HttpHelloWorldClientHandler.class.getName());
