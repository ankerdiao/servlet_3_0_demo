...
public class ThriftProtocolDecoder extends LengthFieldBasedFrameDecoder {
	 ...
	 * @return
	 */
	private static int byte2Length(byte[] bb) {
	...
	public static void main(String[] args) {
		byte[] ln = new byte[]{0, 0, 1, 12};
		System.out.println(byte2Length(ln));
	}
